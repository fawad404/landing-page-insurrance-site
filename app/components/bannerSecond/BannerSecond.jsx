      ...
      <section className="bg-white py-10 md:p-20 md:pb-0 md:pt-0">
        <div className="w-full mx-auto flex flex-col md:flex-row items-start bg-white p-6 rounded-lg">
          <div className="md:w-4/12 md:p-10 md:pl-0 flex flex-col items-start">
            ...
            <p className="text-gray-700 mb-4 font-cabin text-lgmd:text-base lg:w-[90%] mt-3">
          ...
          <div className="md:w-4/12 md:p-10 md:pl-0 flex flex-col items-start">
            ...
            <p className="text-gray-700 mb-4 text-lgmd:text-base font-serif lg:w-[90%] mt-3">
          ...
          <div className="md:w-4/12 md:p-10 md:pl-0 flex flex-col items-start">
            ...
            <p className="text-gray-700 mb-4 text-lgmd:text-base font-serif lg:w-[100%] mt-3">
