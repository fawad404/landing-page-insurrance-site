      ...
      <div className="p-2 md:p-4 flex flex-col items-center">
        <div className="bg-white w-full max-w-4xl p-8 pt-0 md:p-20 md:pt-0 rounded-lg">
          ...
          <div className="mt-6  text-[#c04f15] text-lg md:text-2xl md:ml-56 flex items-center justify-start">
                <input
                    type="text"
                    className="bg-[#f2aa84] text-lg text-white placeholder-white rounded-md border-none px-2 py-0 focus:outline-none focus:ring-2 focus:ring-[#c04f15] focus:ring-opacity-50 shadow-md w-full max-w-xs md:max-w-xs"
                    placeholder=""
                />
                </div>
