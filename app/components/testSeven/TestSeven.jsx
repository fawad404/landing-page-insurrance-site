    ...
    <div className="text-textColor flex items-center min-h-[55vh] justify-center">
        ...
        <div className="w-full max-w-3xl  p-6 relative">
            ...
            <div className="relative">
                <h1 className="text-2xl italic text-[#c04f15]  mb-4 hover-trigger">Gesundheitsstatus
                <span className="inline-block ml-1 group">
            <span className="text-[#c04f15] absolute -top-2 left-52">
            ...
            <h2 className="text-lg md:text-2xl text-[#c04f15] mt-8 mb-8">Vorhandene Diagnosen/Behandlungen in den letzten 5
                Jahren</h2>

            
            <div className="grid grid-cols-1 md:grid-cols-2 text-lg  gap-4 mb-6 text-[#c04f15]">
                ...
                <label className="flex checkbox-label gap-x-3 items-center">
                    <input type="checkbox" className="form-checkbox h-4 w-4 text-[#c04f15]" />
