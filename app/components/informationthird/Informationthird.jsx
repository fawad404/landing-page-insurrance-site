  ...
  return (
    <div className='p-1 md:p-32'>
      <div className="p-6 bg-gray-50 w-full mx-auto my-6 rounded-lg">
        ...
        <p className="mt-4 max-w-xl mb-2 text-sm md:text-base">
        ...
        <a href="#" className="text-blue-500 underline cursor-pointer text-sm md:text-base" onClick={toggleVisibility}>
          Mehr Informationen
        </a>
        {isVisible && (
          <div className="mt-4 p-2 md:p-4 bg-white border border-orange-600 text-sm md:text-base">
            <p>
