...
const TestFifth = () => {
  return (
    <>
      <ComHeader />
      <h2 className="p-20 md:p-10 pb-0 md:pb-2 text-[#c04f15] text-xl md:text-2xl lg:text-3xl italic mb-6 flex md:block md:justify-start -ml-8 md:-ml-0">
        ...
        <div className="bg-white w-full max-w-4xl p-8 pt-0 md:p-20 md:pt-0 rounded-lg">
          ...
          <div className="mt-6  text-[#c04f15] text-lg md:text-2xl flex md:ml-56 items-center justify-start">
                <input
                    ...
                    className="bg-[#f2aa84] text-lg text-white placeholder-white rounded-md border-none px-2 py-0 focus:outline-none focus:ring-2 focus:ring-[#c04f15] focus:ring-opacity-50 shadow-md w-full max-w-xs md:max-w-40"
                    placeholder=""
                />
                </div>
