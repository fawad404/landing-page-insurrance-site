...
const TestFifteen = ({ data, onChange }) => {
...
<div className="w-full max-w-3xl bg-white  relative">
      <h2 className="text-2xl mb-6  text-[#c25115]">Für ein verbessertes Leistungsspektrum in der Krankenversicherung bin ich bereit in der Privaten auch mehr zu zahlen, als in der Gesetzlichen</h2>
